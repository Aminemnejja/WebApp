...
import requests
BASE_URL = "https://webapp-esz7.onrender.com:8501"

def get_matrix_values_A():
    try:
        # Effectuer une requête GET pour récupérer les valeurs de la matrice
        response = requests.get("f{BASE_URL}/get_matrix_values_A")
...
def get_matrix_values_B():
    try:
        # Effectuer une requête GET pour récupérer les valeurs de la matrice
        response = requests.get("f{BASE_URL}//get_matrix_values_B")
        # Vérifier si la requête a réussi (code de statut 200)
        if response.status_code == 200:
...
def get_vector_values():
    try:
        ...
        response = requests.get("f{BASE_URL}//get_vector_values")
        # Vérifier si la requête a réussi (code de statut 200)
        if response.status_code == 200:
...
<body>
    ...
    <script>
        ...
        function getMatrixValuesFromPython() {
            ...
            fetch('https://webapp-esz7.onrender.com:8501/get_matrix_values_A')
        ...
        function updateMatrixValuesInPython() {
            saveMatrixValues();
            fetch('https://webapp-esz7.onrender.com:8501/update_matrix_values_A', {
                    method: 'POST',
                    headers: {
...
<body>
    ...
    <script>
        ...
        function getVectorValuesFromPython() {
            fetch('https://webapp-esz7.onrender.com:8501/get_vector_values')
        ...
        function updateVectorValuesInPython() {
            saveVectorValues();
            fetch('https://webapp-esz7.onrender.com:8501/update_vector_values', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
...
<body>
    ...
    <script>
        ...
        function getMatrixValuesFromPython() {
            ...
            fetch('https://webapp-esz7.onrender.com:8501/get_matrix_values_B')
            updateMatrixValuesInPython()
                .then(response => response.json())
                .then(data => {
                    matrixValuesB = data;
        ...
        function updateMatrixValuesInPython() {
            saveMatrixValues();
            fetch('https://webapp-esz7.onrender.com:8501/update_matrix_values_B', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
